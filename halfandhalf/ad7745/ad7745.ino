...
AD7746 testing with Monochrome OLED for output, since we want to test with a ground-free setup (battery powered)

Use Mega for memory issue; use local display (Adafruit OLED 132x64)

20140829   - Version works, shows fraction of capacitance 

20140829a  - Have option to change between pins 3/7/8 and 4/9/10, since the AD7746 has two capacitance inputs
